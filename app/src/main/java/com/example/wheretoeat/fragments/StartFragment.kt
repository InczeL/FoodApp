    ...
    override fun onCreateView(
        ...
        binding.singInBtn.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                ...
                findNavController().navigate(R.id.action_startFragment_to_singInFragment,savedInstanceState)
            }
        ...
        binding.loginBtn.setOnClickListener{
               /* if(binding.userName.text.isEmpty() || binding.password.text.isEmpty()){
                    ...
                    if(user.password == binding.password.text.toString()){*/
                        findNavController().navigate(R.id.action_startFragment_to_mainActivity,savedInstanceState)
                    /*}
                    else{
